...
function Dashboard({ onNavigateToDashboard }: { onNavigateToDashboard: () => void }) {
  return (
    ...
    >
      <DashboardIcon />
      <div className="flex flex-col font-sans justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-neutral-100 text-nowrap tracking-[-0.48px]">
...
function SignIn() {
  return (
    ...
    >
      <WalletIcon />
      <div className="[text-shadow:#000000_0px_-1px_2px] flex flex-col font-bold justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-nowrap text-white tracking-[-0.48px]">
        <p className="leading-[1.2] whitespace-pre">
          Connect Wallet
        </p>
      </div>
